...
class ACVTreeAgnostic(BaseTree):
    ...
    def compute_sdp_rule_fast(self, x, y, S, min_node_size=5, classifier=1, t=20):
        sdp, rules = cyext_acv.compute_sdp_rule_fast(x, y, S, self.features, self.thresholds, self.children_left,
                                       self.children_right, self.max_depth, min_node_size, classifier, t)
        return sdp, rules
